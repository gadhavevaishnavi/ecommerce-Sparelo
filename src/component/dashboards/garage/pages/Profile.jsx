...
import { FaUser, FaEnvelope, FaLock, FaPhone, FaMapMarkerAlt, FaCamera, FaSave, FaEdit, FaTimes, FaTools, FaCertificate, FaBuilding } from 'react-icons/fa';
...
const Profile = () => {
  ...
  useEffect(() => {
    const savedProfile = localStorage.getItem('garage_profile');
    if (savedProfile) {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('garage_profile', JSON.stringify(profileToSave));
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-lg font-bold text-gray-900">{formData.name || 'Garage User'}</h4>
              <p className="text-sm text-gray-600">{formData.email || 'garage@example.com'}</p>
              <span className="mt-2 px-3 py-1 text-xs rounded-full bg-purple-100 text-purple-800">
                Garage
              </span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <FaTools className="text-purple-500" /> Garage Information
              </h4>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100"
                    placeholder="e.g., Engine Repair, Brake Service, AC Service, etc."
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100"
                    placeholder="e.g., ASE Certified, Authorized Service Center, etc."
                  />
                </div>
              </div>
            </div>
