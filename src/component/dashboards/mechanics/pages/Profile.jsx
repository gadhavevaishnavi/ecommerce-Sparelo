...
import { FaUser, FaEnvelope, FaLock, FaPhone, FaMapMarkerAlt, FaCamera, FaSave, FaEdit, FaTimes, FaWrench, FaCertificate, FaIdCard } from 'react-icons/fa';
...
const Profile = () => {
  ...
  useEffect(() => {
    const savedProfile = localStorage.getItem('mechanic_profile');
    if (savedProfile) {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('mechanic_profile', JSON.stringify(profileToSave));
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-lg font-bold text-gray-900">{formData.name || 'Mechanic User'}</h4>
              <p className="text-sm text-gray-600">{formData.email || 'mechanic@example.com'}</p>
              <span className="mt-2 px-3 py-1 text-xs rounded-full bg-orange-100 text-orange-800">
                Mechanic
              </span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <FaWrench className="text-orange-500" /> Professional Information
              </h4>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      <FaIdCard className="inline mr-2" /> Mechanic ID
                    </label>
                    <input
                      type="text"
                      name="mechanicId"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100"
                    placeholder="e.g., ASE Certified, Automotive Technician, etc."
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={!isEditing}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100"
                    placeholder="e.g., City Center, Downtown, Suburbs"
                  />
                </div>
              </div>
            </div>
